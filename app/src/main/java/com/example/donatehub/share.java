    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shareBtn.setOnClickListener(new View.OnClickListener() {
            ...
            private void shareApp(Context context) {
                final String apkName = context.getPackageName();
                Intent intent = new Intent();
                intent.setAction(Intent.ACTION_SEND);
                intent.putExtra(Intent.EXTRA_TEXT,"Visit Here "+"https://donatehubgreatings.netlify.app/");
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(share.this, MainActivity.class);
            }
        });
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(share.this, setting.class);
            }
        });
        ...
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(share.this, about.class);
            }
        });
            ...
            databaseReference.child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        // Glide.with(share.this).load(profileImageUrl).into(profileImage);
                    }
                }
